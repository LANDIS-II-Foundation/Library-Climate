...
namespace Landis.Library.Climate
{
    ...
    public static class Climate
    {
        ...
        */
        ...
        public static Dictionary<int, double[]>[] FutureMonthlySpei { get; set; }     // [ecoregion index][year] -> monthly spei
        public static Dictionary<int, double[]>[] SpinupMonthlySpei { get; set; }     // [ecoregion index][year] -> monthly spei
