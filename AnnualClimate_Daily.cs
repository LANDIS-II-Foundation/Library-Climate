...
namespace Landis.Library.Climate
{
    public class AnnualClimate_Daily : AnnualClimate
    {
        ...
        public double[] DailySpei = new double[366];
                ...
                case "Daily_RandomYears":
                    {
                        ...
                        this.DailySpei = MonthlySpeiDataToDaily(speiData[actualTimeStep], dailyData.Length == 366);
                        break;
                    }
                ...
                case "Daily_AverageAllYears":
                    {
                        ...
                        CalculateDailyData(ecoregion, dailyData, actualTimeStep, latitude);
                        this.DailySpei = MonthlySpeiDataToDaily(Spei.AverageSpeiOverYears(speiData), false);    // this option always returns length-365 data, so convert Spei data as non-leapyear
                        break;
                    }
        ...
        private static double[] MonthlySpeiDataToDaily(double[] monthlyData, bool isLeapYear)
        {
            var dailyData = new List<double>();

            var daysInMonth = isLeapYear ? new[] { 31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 } : new[] { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
